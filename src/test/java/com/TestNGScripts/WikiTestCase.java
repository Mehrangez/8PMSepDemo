...
public class WikiTestCase {
	...
	/// The steps will be returned as user defined methods 
	...
	// A method which has before class annotation will get executed as the first method of the class.. only once	
		...
		public static void setup()
		{
			...
			driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS); /// implicit wait is added in the begining to be added to all code elements) 
		...
		{
			// test steps to perform testcase goes her   e
